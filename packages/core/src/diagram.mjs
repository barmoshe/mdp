...
// flow: a layered DAG, top to bottom. Each node's layer is its longest path from a
// source (relaxation, capped so a cycle stays total). Layers centre horizontally.
